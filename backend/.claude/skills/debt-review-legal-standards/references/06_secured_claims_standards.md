...
- Ultra vires guarantee effectiveness framework (越权担保效力认定)
- Ninth Civil Minutes application (九民纪要第17-19条适用)
- Guarantee period vs. statute of limitations (保证期间与诉讼时效)
- Spousal joint debt determination (夫妻共同债务认定)
- 7 Supreme Court case citations with ruling principles
- 8-step comprehensive application process
